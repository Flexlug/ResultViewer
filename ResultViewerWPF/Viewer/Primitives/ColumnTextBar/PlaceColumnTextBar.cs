...
namespace ResultViewerWPF.Viewer.Primitives.ColumnTextBar
{
    ...
    /// </summary>
    public class PlaceColumnTextBar : Bar
    {
        ...
        /// </summary>
        public PlaceColumnTextBar(Canvas parentCanvas)
        {
            ...
            textControl = new TextBlock()
            {
                VerticalAlignment = VerticalAlignment.Center,
                HorizontalAlignment = HorizontalAlignment.Center,
                FontSize = Program.Settings.PlaceColumnPhraseFontSize,
                Foreground = new SolidColorBrush(Program.Settings.PlaceColumnPhraseFontColor),
                TextAlignment = TextAlignment.Center,
                FontWeight = Program.Settings.PlaceColumnPhraseFontWeight,
                TextDecorations = Program.Settings.PlaceColumnPhraseIsUnderlined ? TextDecorations.Underline : null,
                Text = ""
            };
            ...
            if (Program.Settings.PlaceColumnPhraseShowMode != Program.Settings.PhraseShowMode.Never)
                // Если надпись включена - грузим текст. Иначе текст вообще загружен не будет
                Text = Program.Settings.PlaceColumnPhrase;
        }
    }
}