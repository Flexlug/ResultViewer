...
namespace ResultViewerWPF.Viewer.Primitives.ColumnTextBar
{
    ...
    /// </summary>
    public class ResultColumnTextBar : Bar
    {
        ...
        /// </summary>
        public ResultColumnTextBar(Canvas parentCanvas)
        {
            ...
            textControl = new TextBlock()
            {
                VerticalAlignment = VerticalAlignment.Center,
                HorizontalAlignment = HorizontalAlignment.Center,
                FontSize = Program.Settings.ResultColumnPhraseFontSize,
                Foreground = new SolidColorBrush(Program.Settings.ResultColumnPhraseFontColor),
                TextAlignment = TextAlignment.Center,
                FontWeight = Program.Settings.ResultColumnPhraseFontWeight,
                TextDecorations = Program.Settings.ResultColumnPhraseIsUnderlined ? TextDecorations.Underline : null,
                Text = ""
            };
            ...
            if (Program.Settings.ResultColumnPhraseShowMode != Program.Settings.PhraseShowMode.Never)
                // Если надпись включена - грузим текст. Иначе текст вообще загружен не будет
                Text = Program.Settings.ResultColumnPhrase;
        }
    }
}