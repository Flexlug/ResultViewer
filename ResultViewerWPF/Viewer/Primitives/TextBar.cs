    ...
    public class TextBar : Bar
    {
        ...
        public TextBar(Canvas parentCanvas, string text = "")
        {
            ...
            textControl = new TextBlock()
            {
                VerticalAlignment = VerticalAlignment.Center,
                HorizontalAlignment = HorizontalAlignment.Center,
                FontSize = Program.Settings.LowerPhraseFontSize,
                Foreground = new SolidColorBrush(Program.Settings.LowerPhraseFontColor),
                TextAlignment = TextAlignment.Center,
                FontWeight = Program.Settings.LowerPhraseFontWeight
            };
